    ...
    <main className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="mb-12 border-b border-slate-100 pb-6">
           ...
           <p className="text-slate-500 mt-1">Browse our complete list of available formulations.</p>
        </div>
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full aspect-[4/3] bg-slate-50 border border-slate-100 rounded-xl overflow-hidden shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:border-slate-200">
                  <Image
                ...
                <div className="mt-5">
                  ...
                  <span className="mt-4 inline-flex items-center text-sm font-semibold text-novitrail-blue group-hover:underline underline-offset-4">
                    View specification 
