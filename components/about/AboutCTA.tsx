...
export default function AboutCTA() {
  return (
    <section className="relative py-28 overflow-hidden bg-gradient-to-br from-novitrail-blue-light via-blue-50 to-white dark:from-slate-900 dark:via-novitrail-blue-dark dark:to-slate-900">
      ...
      />
      <div className="absolute top-10 left-[12%] w-24 h-24 border border-novitrail-blue/10 dark:border-white/5 rounded-full animate-float pointer-events-none" />
      <div className="absolute bottom-12 right-[10%] w-16 h-16 border border-novitrail-blue/10 dark:border-white/5 rounded-full animate-float-delayed pointer-events-none" />

      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <ScrollReveal>
          <h2 className="text-novitrail-blue dark:text-white mb-6!">Partner With Novitrail Pharmaceuticals</h2>
        </ScrollReveal>
        <ScrollReveal delay={0.15}>
          <p className="text-slate-600 dark:text-slate-300 mb-10 text-lg max-w-2xl mx-auto leading-relaxed">
            Connect with us to discuss manufacturing, bulk supply, and export opportunities tailored to your market.
          </p>
        </ScrollReveal>
